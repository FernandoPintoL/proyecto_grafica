...
public class FlappyBirdGame {
    ...
    public void run() {
        ...
        loop();      // Paso 2: Bucle principal (procesa input, actualiza lógica, renderiza)
    ...
    private void loop() {
        ...
        while (!GLFW.glfwWindowShouldClose(window)) {
            ...
            renderer.render(game, game.particles, windowWidth, windowHeight);
    ...
    private void processInput() {
        ...
        if (wNow && !prevW) {
            if (!game.gameStarted) {
                ...
                game.particles.jumpDust(game.bird1.x, game.bird1.y); // Crear partículas de polvo
